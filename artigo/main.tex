...
Em cada cenário, os cinco algoritmos processaram 100 cargas de trabalho idênticas (1.000 processos cada, gerados por \textit{seeds} aleatórias). As métricas principais analisadas foram o Tempo de Retorno Médio (\textit{Turnaround}), o total de Trocas de Contexto e o Índice de Jain do Slowdown (métrica de equidade/justiça)~\cite{jain1984}. Os gráficos apresentam a média e o Intervalo de Confiança de 95\% (IC95\%).
