...
def execute(args: argparse.Namespace) -> int:
    ...
    if len(observations) != 1600:
        raise EvidenceError("a validacao nao retornou as 1.600 observacoes canonicas")
    ...
    if args.verify_only:
        ...
        print(
            f"Evidencia valida: {tag}, 400 workloads, 1600 resultados, "
