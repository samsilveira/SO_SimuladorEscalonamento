...
| Sabrina Alencar Soares (@sabrinaalencar) | - | Apoio na finalização e revisão do artigo (#17) |
| Samuel Wagner Tiburi Silveira (@samsilveira) | #1, #6 | Especificação/README, decisões do modelo e protocolo experimental (#1), trocas de contexto, métricas obrigatórias e suíte de testes (#6). Atualização do README (#17) |
| Sebastião Sousa Soares (@SebastiaoSoares) | #9 | Criação e implementação do algoritmo PDBH (Prioridade Dinâmica Baseada em Histórico) e sua documentação detalhada (#9) |
